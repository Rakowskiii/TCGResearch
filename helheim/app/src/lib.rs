...
pub async fn run() {
    ...
    let app_state = appstate::AppState {
        client: crate::models::utgard::UtgardClient::new(
            wallet,
            contract_address,
            &*RPC_URL,
        ),
    ...
    let app = axum::Router::new()
        .route("/register_game", axum::routing::post(crate::routes::register_game::handler))
        .route("/register_collection", axum::routing::post(crate::routes::register_collection::handler))
        .route("/sign_booster", axum::routing::get(crate::routes::sign_booster::handler))
        .route("/register", axum::routing::post(crate::routes::register_user::handler))
